...
def start_screen():
    global screen
    pg.display.set_caption("Mars Reconnaissance Orbiter")
    screen.fill(BLACK)
    background = pg.image.load("background.png").convert()
    screen.blit(background, (0, 0))
    draw_text(screen, 'Mars Reconnaissance Orbiter', 60, WHITE, 400, 470)
    ...
    image=pg.image.load("mgspatch1.jpg").convert()
